...
def task(request, task_id):
    ...
    if request.method == "POST":
        ...
        return HttpResponse(render(request, 'contest/task.html', {"text" : task.text, "form" : form, "res" : res}))
    else:
        return HttpResponse(render(request, 'contest/task.html', {"text" : task.text, "form" : NumSolveForm(), "res" : res}))
